...
class MCPConfigManager:
    ...
    def load_config(self) -> MCPConfig:
        ...
        try:
            ...
            console.print(Text(f'Warning: Failed to load MCP config: {e}', style=ColorStyle.WARNING))
            self._config = MCPConfig()
            return self._config
    ...
    def save_config(self, config: Optional[MCPConfig] = None) -> bool:
        ...
        try:
            ...
            console.print(Text(f'Error: Failed to save MCP config: {e}', style=ColorStyle.ERROR))
            return False
