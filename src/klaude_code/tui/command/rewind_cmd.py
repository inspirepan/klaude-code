...
class RewindCommand(CommandABC):
    ...
    Unlike the model's in-place `Rewind` tool (agent/rewind/AGENTS.md), this
    user command forks a new session and carries the discarded tail over as a
    summary — nothing is lost, and the original session stays switchable.
    """
