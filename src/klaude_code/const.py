...
SUSPEND_DETECTION_THRESHOLD_S = 10.0  # Wall-clock vs monotonic gap during a step that counts as an OS suspend (seconds)
...
DIFF_MAX_RENDER_WIDTH = 180  # Maximum width for highlighted diff rows
...
READ_PARTIAL_PREVIEW_MAX_LINES = 3  # Lines shown in Read preview when reading from the middle of a file
...
def find_jj_workspace_root(*, work_dir: Path) -> Path | None:
    """Find nearest Jujutsu workspace root by walking parents and checking for .jj."""
