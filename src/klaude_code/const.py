...
INTERRUPT_MARKER = "<system interrupted by user>"  # Marker appended when assistant is interrupted
...
SUB_AGENT_RESULT_MAX_LINES = 20  # Maximum lines for sub-agent result display
SUB_AGENT_ERROR_MAX_LINES = 2  # Maximum lines for sub-agent error display
