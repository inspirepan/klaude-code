...
LLM_FIRST_TOKEN_TIMEOUT_S = 120.0  # Retry turn if no valid first token arrives within this time (seconds)
...
READ_PARTIAL_PREVIEW_MAX_LINES = 3  # Lines shown in Read preview when offset/limit is provided
