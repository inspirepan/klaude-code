...
AGENT_REVIEW_INST = (
    ...
    "throwaway experiment. A task with no edits of your own -- an answer, a diagnosis, a read-only investigation "
    "-- has nothing to review; never launch a reviewer on changes you did not make. The review is part of "
