...
class TestSmartTruncationStrategy:
    ...
    def test_read_tool_not_truncated(self):
        ...
        tool_call = model.ToolCallItem(call_id="test_id", name=tools.READ, arguments="{}")
        long_text = "a" * 100
    ...
    def test_truncation_saves_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            text = "a" * 200
            tool_call = model.ToolCallItem(call_id="test_call_123", name="TestTool", arguments="{}")
    ...
    def test_get_file_identifier_fallback(self):
        ...
        strategy = SmartTruncationStrategy()
        tool_call = model.ToolCallItem(call_id="my_call_id", name="SomeTool", arguments="{}")
