...
def test_load_auto_memory_without_truncation(monkeypatch, tmp_path: Path) -> None:
...
def test_load_auto_memory_with_truncation_notice(monkeypatch, tmp_path: Path) -> None:
