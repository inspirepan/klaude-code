...
class TestEditTool(BaseToolTest):
    ...
    def test_edit_simple_replacement(self):
        ...
        # Edit the file
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': 'Hello, World!', 'new_string': 'Hi, Universe!'})
    ...
    def test_edit_multiline_replacement(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': 'Line 2\nLine 3\nLine 4', 'new_string': 'New Line 2\nNew Line 3'})
    ...
    def test_edit_without_reading_first(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': 'Original', 'new_string': 'Modified'})
    ...
    def test_edit_non_existent_file(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(self.temp_path / 'non_existent.txt'), 'old_string': 'something', 'new_string': 'something else'})
    ...
    def test_edit_string_not_found(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': 'Not present', 'new_string': 'Replacement'})
    ...
    def test_edit_non_unique_string(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': 'Test line', 'new_string': 'Modified line'})
    ...
    def test_edit_replace_all(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': 'Apple', 'new_string': 'Orange', 'replace_all': True})
    ...
    def test_edit_identical_strings(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': 'content', 'new_string': 'content'})
    ...
    def test_edit_with_special_characters(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': '# Comment with $pecial char$', 'new_string': '# Updated comment'})
    ...
    def test_edit_preserves_line_endings(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': 'Line 2', 'new_string': 'Modified Line 2'})
    ...
    def test_edit_empty_file(self):
        ...
        result = self.invoke_tool(EditTool, {'file_path': str(test_file), 'old_string': 'something', 'new_string': 'something else'})
