...
class TestFileConfigSource:
    ...
    def test_file_config_source_load_existing_file(self):
        ...
        config_data = {'api_key': 'test_key', 'model_name': 'test_model', 'max_tokens': 1000}
    ...
    def test_create_example_config_default_path(self):
        ...
        with patch('pathlib.Path.mkdir'), patch('builtins.open', create=True), patch('json.dump'), patch('klaudecode.tui.console.print'):
