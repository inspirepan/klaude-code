...
class TestSessionStorage:
    ...
    def test_save_session_with_user_messages(self):
        ...
        session.append_message(
            UserMessage(content='Hello', user_raw_input='Hello'),
    ...
    def test_save_session_auto_title_generation(self):
        session = Session(work_dir=self.work_dir)
        session.append_message(
            UserMessage(content='This is my question', user_raw_input='This is my question'),
            AIMessage(content='This is the answer')
        )
    ...
    def test_load_session_with_tool_messages(self):
        ...
        original_session.append_message(
            UserMessage(content='Test', user_raw_input='Test'),
            ai_msg,
            tool_msg
        )
