...
class TestSessionOperations:
    ...
    async def test_compact_conversation_history_success(self):
        ...
        with patch('klaudecode.session.session_operations.console.print') as mock_print:
            await SessionOperations.compact_conversation_history(session, instructions='test instructions', show_status=True, llm_manager=llm_manager)
    ...
    async def test_compact_conversation_history_with_additional_instructions(self):
        ...
        await SessionOperations.compact_conversation_history(session, instructions='Please focus on technical details', llm_manager=llm_manager)
    ...
    async def test_analyze_conversation_for_command_success(self):
        ...
        mock_tool_call = ToolCall(
            ...
            tool_args_dict={'command_name': 'create_test_file', 'description': 'Creates a test file', 'content': 'create test file $ARGUMENTS'},
        )
