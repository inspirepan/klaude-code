...
class TestToolMessage:
    def test_tool_message_basic_initialization(self):
        ...
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Tool result content')
    ...
    def test_tool_message_with_error(self):
        tool_call = ToolCall(id='call_123', tool_name='test_tool')
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Some content', error_msg='An error occurred')

        assert tool_msg.error_msg == 'An error occurred'

    def test_tool_message_with_system_reminders(self):
        tool_call = ToolCall(id='call_123', tool_name='test_tool')
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, system_reminders=['Reminder 1', 'Reminder 2'])
    ...
    def test_get_content_basic(self):
        ...
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Basic tool result')
    ...
    def test_get_content_canceled_status(self):
        ...
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Original content')
    ...
    def test_get_content_error_status(self):
        ...
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Some content', error_msg='Error details')
    ...
    def test_get_content_with_attachments(self):
        ...
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Basic content', attachments=[attachment])
    ...
    def test_get_content_with_system_reminders(self):
        tool_call = ToolCall(id='call_123', tool_name='test_tool', status='success')
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Content', system_reminders=['Reminder 1', 'Reminder 2'])
    ...
    def test_to_anthropic_with_error(self):
        tool_call = ToolCall(id='call_123', tool_name='test_tool', status='error')
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Error content', error_msg='Something went wrong')
    ...
    def test_bool_removed_message(self):
        tool_call = ToolCall(id='call_123', tool_name='test_tool')
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Some content', removed=True)
    ...
    def test_append_post_system_reminder_existing_list(self):
        tool_call = ToolCall(id='call_123', tool_name='test_tool')
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, system_reminders=['Existing reminder'])
    ...
    def test_get_suffix_renderable_no_custom_renderer_with_content(self):
        tool_call = ToolCall(id='call_123', tool_name='test_tool', status='success')
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Some result content')
    ...
    def test_get_suffix_renderable_error_status(self):
        tool_call = ToolCall(id='call_123', tool_name='test_tool', status='error')
        tool_msg = ToolMessage(tool_call_id='call_123', tool_call_cache=tool_call, content='Content', error_msg='Error details')
