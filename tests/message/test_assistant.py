...
class TestCompletionUsage:
    def test_completion_usage_initialization(self):
        usage = CompletionUsage(
            completion_tokens=100, prompt_tokens=50, total_tokens=150
        )
...
class TestAgentUsage:
    ...
    def test_update_with_ai_message_no_usage(self):
        usage = AgentUsage(
            total_llm_calls=1, total_input_tokens=10, total_output_tokens=20
        )
        ai_msg = AIMessage()
    ...
    def test_update_multiple_calls(self):
        ...
        ai_msg1 = AIMessage(
            usage=CompletionUsage(
                completion_tokens=50, prompt_tokens=25, total_tokens=75
            )
        )
        ai_msg2 = AIMessage(
            usage=CompletionUsage(
                completion_tokens=30, prompt_tokens=15, total_tokens=45
            )
        )
    ...
    def test_update_with_usage(self):
        usage1 = AgentUsage(
            total_llm_calls=2, total_input_tokens=100, total_output_tokens=200
        )
        usage2 = AgentUsage(
            total_llm_calls=3, total_input_tokens=150, total_output_tokens=300
        )
