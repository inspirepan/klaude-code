...
class TestToolCall:
    def test_tool_call_basic_initialization(self):
        tool_call = ToolCall(
            id="call_123",
            tool_name="test_tool",
            tool_args_dict={"param1": "value1", "param2": 42},
        )
    ...
    def test_tool_args_property(self):
        tool_call = ToolCall(
            id="call_123",
            tool_name="test_tool",
            tool_args_dict={"param": "value", "number": 123},
        )
    ...
    def test_initialization_tool_args_dict_takes_precedence(self):
        tool_call = ToolCall(
            id="call_123",
            tool_name="test_tool",
            tool_args='{"should": "be_ignored"}',
            tool_args_dict={"actual": "value"},
        )
    ...
    def test_to_anthropic(self):
        tool_call = ToolCall(
            id="call_123",
            tool_name="test_tool",
            tool_args_dict={"param": "value", "number": 42},
        )
