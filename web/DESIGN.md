...
Unified color families: **emerald** for success, **red** for error, **amber** for warning/interrupt, **blue** for interactive UI, **sky** for active/running state.
...
| Blue-500/600        | `#3b82f6` / `#2563eb`             | Primary interactive accent -- submit buttons, selected options, focused inputs            |
| Blue-50/80          | `#eff6ff`                         | Selected pill backgrounds, focus rings                                                   |
| Sky-600             | `#0284c7`                         | Active/running state -- in-progress todo icons and text, planned group in-progress labels |
