...
// klaude: upstream cross-package imports -> the vendored primitives tree and
...
import type { JsonTreeLabels, MarkdownLabels } from '../ui-primitives/index.ts'
import { structuredPatch } from 'diff'
import type {
  AssistantRequestConfig, ConversationPromptSnapshot, ImageAttachmentRef, RenderMessageImages,
