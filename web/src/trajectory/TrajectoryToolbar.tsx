...
// klaude: ui-slots TranslateNS -> the flat local TrajectoryTranslate;
// upstream cross-package import -> the vendored primitives tree
import { IconSearchOutline16 } from '../ui-primitives/index.ts'
...
export interface TrajectoryToolbarProps {
  ...
  t: TrajectoryTranslate // klaude: was TranslateNS<typeof NS>
}
