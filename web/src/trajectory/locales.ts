...
// klaude: the ui-slots LocaleNamespaceMap augmentation is dropped and the
// namespace-bound translator becomes the flat local signature in src/locale.ts
/** Namespace-bound translator threaded through trajectory presentation code. */
export type { TrajectoryTranslate } from '../locale.ts'
