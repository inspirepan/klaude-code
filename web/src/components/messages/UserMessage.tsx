...
export function UserMessage({ item }: UserMessageProps): React.JSX.Element {
  ...
  return (
    <>
      <div className="hover:bg-slate-150 dark:hover:bg-slate-750 ml-auto w-fit max-w-[50%] rounded-lg border border-slate-200 bg-slate-100 px-2.5 py-1.5 shadow-sm transition-colors dark:border-slate-700 dark:bg-slate-800">
        {imageElements}
        {hasText ? (
          <div>
            <p
