...
export function UnknownEvent({ item }: UnknownEventProps): JSX.Element {
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <CollapsibleTrigger className="flex items-center gap-1.5 text-zinc-300 hover:text-zinc-400 transition-colors cursor-pointer">
        <ChevronRight
      ...
      <CollapsibleContent>
        <pre className="mt-1 text-xs text-zinc-400 bg-zinc-50 rounded p-2 overflow-x-auto">
