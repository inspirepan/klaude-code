    ...
    <div className="sticky top-0 z-20 flex shrink-0 flex-wrap items-center gap-3 border-b border-neutral-200/80 bg-[#f9f9f8]/80 px-4 py-2 backdrop-blur sm:px-6">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex min-w-0 items-baseline gap-2 text-base leading-5">
          ...
          />
          {sessionReadOnly ? (
            <span className="group/readonly relative inline-flex shrink-0 cursor-help items-center gap-1 self-center rounded-full border border-amber-200/70 bg-amber-50 px-2 py-0.5 text-xs font-medium text-amber-700">
